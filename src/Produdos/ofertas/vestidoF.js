...
const vestidoF = require('../../img/imgProdDestaques/vestido.jpg');
        ...
        return(
            <ScrollView>
                ...
                <TouchableOpacity  style={{alignItems:'center'}} >
                    <ImageBackground source={vestidoF} style={{ width: '100%', height: 330 }} >
                        <View style={{ marginTop: '20%' }}>
                        <Text style={{marginRight:10, textAlign:'right',alignItems:'center',fontSize:20, fontWeight:'900',color:'white'}}>Vestido:</Text>
