...
const camizaof = require('../../img/modaFeminina/camizao.jpg');
 ...
 function CamizaoFem(){
        ...
        return(
            <ScrollView>
                ...
                <TouchableOpacity  >
                    <ImageBackground source={camizaof} style={{ width: '100%', height: 400 }}>
                        <View style={{ marginTop: '20%' }}>
                        <Text style={{marginRight:10, textAlign:'right',alignItems:'center',fontSize:20, fontWeight:'900',color:'white'}}>Camisão feminino:</Text>
